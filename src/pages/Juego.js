...
const Juego = () => {
    ...
    const { jugadorUno, jugadorDos,
        ...
        partida,
        partidaIniciada,
        setCartasJugadorUno, setCartasJugadorDos } = useJugadores();
    ...
    const consultarCartasAPI = async () => {
        if (partida.deck_id !== undefined && partidaIniciada) {
            ...
            setCartasJugadorDos([...cartasJugadorDos, data.cards[0]]);
            setCartasJugadorUno([...cartasJugadorUno, data.cards[1]]);
        } else {
            Swal.fire({
                icon: 'error',
                title: 'Oops...',
    ...
    return (
        <div className="general">
            <div>
                <button type="button" className="btn btn-danger button reiniciar" onClick={consultarCartasAPI}>
